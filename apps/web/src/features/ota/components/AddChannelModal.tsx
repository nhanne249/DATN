        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(value) => {
                setValue('type', value);
                const label = CHANNEL_TYPES.find((channelType) => channelType.value === value)?.label;
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              {...register('name')}
              placeholder="Ví dụ: Booking.com - Khách sạn A"
          ...
          <div className="space-y-2 p-3 rounded-lg border border-zinc-800 bg-zinc-950/30">
            <p className="text-xs text-zinc-500">
              Sau khi kết nối, bạn cần thiết lập map phòng để bắt đầu đẩy giá và nhận đặt phòng tự động.
            </p>
          </div>
