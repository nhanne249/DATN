        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Sản phẩm bán chạy và xu hướng sử dụng Minibar, F&B.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="bg-gray-50 border-gray-200/50 hover:bg-gray-50 transition-colors">
                    <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">DT Dịch Vụ</p>
                ...
                <Card className="bg-gray-50 border-gray-200/50 hover:bg-gray-50 transition-colors">
                    <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">Tổng sản phẩm</p>
                                <h3 className="text-3xl font-bold text-gray-900 mt-2">{kpi.totalQty} <span className="text-lg font-normal text-gray-400">sp</span></h3>
                            </div>
                ...
                <Card className="bg-gray-50 border-gray-200/50 hover:bg-gray-50 transition-colors">
                    <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">Top T.Thu</p>
                                <h3 className="text-xl font-bold text-gray-900 mt-1 pt-1">{kpi.topRev.name}</h3>
                                <p className="text-xs text-gray-400 mt-1">{formatVND(kpi.topRev.revenue)}</p>
                            </div>
                ...
                <Card className="bg-gray-50 border-gray-200/50 hover:bg-gray-50 transition-colors">
                    <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">Top Số lượng</p>
                                <h3 className="text-xl font-bold text-gray-900 mt-1 pt-1">{kpi.topCnt.name}</h3>
                                <p className="text-xs text-gray-400 mt-1">{kpi.topCnt.count} lượt khách mua</p>
                            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="bg-white border-zinc-900 shadow-lg">
                    <CardHeader className="border-b border-gray-200/50 pb-4">
                        <CardTitle className="text-lg font-semibold text-gray-900">Top Dịch vụ (Theo Doanh thu)</CardTitle>
                    </CardHeader>
                ...
                <Card className="bg-white border-zinc-900 shadow-lg">
                    <CardHeader className="border-b border-gray-200/50 pb-4">
                        <CardTitle className="text-lg font-semibold text-gray-900">Xu hướng tiêu thụ Dịch vụ (7 ngày)</CardTitle>
                    </CardHeader>
                    <CardContent className="pt-6">
                        <div className="h-[350px] w-full">
                            <ResponsiveContainer width="100%" height="100%">
